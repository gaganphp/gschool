...
function draw_calendar($month,$year,$day){
		...
		for($list_day = 1; $list_day <= $days_in_month; $list_day++):
			...
			$calendar.= '<td class="calendar-day" style="background-color:'.$bgColor.';opacity:'.$disabledOpacity.'">';
				...
				$calendar.= '<div class="day-number">'.$list_day.'</div><a class=" view_attendance '.$disabledClasss.'" data-month="'.ltrim($month,'0').'" data-day="'.$list_day.'" data-year="'.$year.'" >Mark attendance</a>';
